...
const NAV_ITEMS: NavItem[] = [
  ...
  { href: 'https://openclaw.wastetologic.com', label: 'OpenClaw UI', icon: ExternalLink, external: true },
  { href: 'https://bots.wastetologic.com', label: 'Bot Review', icon: ExternalLink, external: true },
];
